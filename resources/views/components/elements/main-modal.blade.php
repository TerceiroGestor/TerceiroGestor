<div x-data="{ show: false }" x-on:open-modal.window="if ($event.detail.id === '{{ $id }}') show = true"
    ...
    class="modal inset-0 fixed z-50 top-0 left-0 right-0 bottom-0 p-6 overflow-auto bg-black/50" x-cloak>

    <!-- Conteúdo do modal -->
    <div class=" top-16 left-16 {{ $class }} relative bg-white rounded shadow-lg mx-auto mt-10 p-6" @click.stop>
