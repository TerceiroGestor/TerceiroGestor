<div>
    <div class="flex justify-end items-center mb-2">
        <button wire:click="edit()" x-on:click="$dispatch('open-modal', { id: 'address' })"
            ...
            <tbody>
                    <tr class="bg-white border-b dark:bg-gray-800 dark:border-gray-700 border-gray-200">
                        ...
                        <td class="px-6 py-4">
                            ...
                            <button wire:click="contactDelete('{{ $address->id }}')"
            ...
            <div x-data="viacep()">
                <fieldset class="border border-gray-300 rounded p-6  mt-4 ">
                    ...
                    <div class="col-span-2">
                        <div class="relative">
                            ...
                            <input wire-model-refer="postal_code" x-ref="cep" x-init="IMask($refs.cep, { mask: '00000-000' })" x-model="postal_code" maxlength="9"
                                type="search" id="postal_code" x-model="postal_code" name="postal_code"
                ...
                <fieldset class="border border-gray-300 rounded p-6  mt-4 grid grid-cols-2 gap-4">
                    ...
                    <div class="">
                        ...
                        <x-text-input wire-model-refer="street" x-model="street" id="street" name="street" type="text"
                            class="mt-1 block w-full" autocomplete="street" placeholder="Logradouro" />
                        <x-input-error class="mt-2" :messages="$errors->get('street')" />
                    </div>
                    <div class="">
                        <x-input-label for="district" :value="__('Bairro')" />
                        <x-text-input wire-model-refer="district" x-model="district" id="district" name="district" type="text"
                            class="mt-1 block w-full" autocomplete="district" placeholder="Bairro" />
                        <x-input-error class="mt-2" :messages="$errors->get('district')" />
                    </div>
                    <div class="">
                        <x-input-label for="number" :value="__('Numero')" />
                        <x-text-input wire-model-refer="number" x-model="number" id="number" name="number" type="text"
                    ...
                    <div class="">
                        ...
                        <x-text-input wire-model-refer="complement" x-model="complement" id="complement" name="complement" type="text"
                    ...
                    <div class="">
                        ...
                        <x-text-input wire-model-refer="city" x-model="city" id="city" name="city" type="text"
                            class="mt-1 block w-full" autocomplete="city" placeholder="Cidade" />
                        <x-input-error class="mt-2" :messages="$errors->get('city')" />
                    </div>
                    <div class="">
                        <x-input-label for="state" :value="__('Estado')" />
                        <x-text-input wire-model-refer="state" x-model="state" id="state" name="state" type="text"
                            class="mt-1 block w-full" autocomplete="state" placeholder="Estado" />
                        <x-input-error class="mt-2" :messages="$errors->get('state')" />
                    </div>
                    <div class="">
                        <x-input-label for="country" :value="__('Pais')" />
                        <x-text-input wire-model-refer="country" x-model="country" id="country" name="country" type="text"
